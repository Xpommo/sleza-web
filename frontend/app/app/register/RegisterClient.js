...
const BENEFITS = [
  ...
  ['Подключение за 10–15 минут', 'Ответьте на вопросы и добавьте одну строку кода. Виджет автоматически разместит куки-баннер, подвал с реквизитами и документами, а также будет следить за актуальностью ссылок.'],
