...
const FAQ = [
  ...
  ['Могу я добавить второй сайт?', 'Да — на «Мои сайты» нажмите «Добавить сайт». Документы, виджет, тариф и год подписки у каждого сайта свои: новый сайт оплачивается за свой год отдельно. Способ оплаты и плательщик — общие на аккаунт.'],
  [
    'Как отключить сайт?',
    'В «Подписке», в строке нужного сайта, — «Отключить». Отключается только он: виджет и документы работают до конца оплаченного года, продлевать его не будем. Там же меняется тариф каждого сайта.',
  ],
  [
