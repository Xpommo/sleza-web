...
const FAQ = [
  [
    ...
    'С баланса аккаунта: пополните его в «Балансе и платежах» картой или по счёту, а оплата года каждого сайта спишется сама в его дату продления. Оплатить год можно и заранее — в «Моих сайтах», вид «Таблица», в строке сайта: не хватит на балансе — доплатите там же. Срок продлится на 12 месяцев.',
  ],
  [
  ...
  [
    ...
    'В разделе «Документы» сайта, в блоке «Что можно изменить», нажмите «Изменить» у «Реквизитов владельца» — поправите поля сами. Документ и подвал сайта обновятся вместе с ними. Реквизиты для счёта — отдельные, они в «Балансе и платежах».',
  ],
  ...
  ['Где чеки, счета и акты?', 'В «Балансе и платежах», на вкладке «Документы»: почта, на которую они приходят, и акты за оплаченные годы сайтов. История операций по балансу — на вкладке «Платежи».'],
  [
