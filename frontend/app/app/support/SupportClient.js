...
// (у каждого сайта свой тариф и год подписки, отключение в «Подписке»,
// реквизиты в «Документах»), здесь они приведены к действительности.
const FAQ = [
  [
    'Как оплачивается подписка?',
    'С баланса аккаунта: пополните его в «Подписке» картой или по счёту, а оплата года каждого сайта спишется сама в его дату продления. Оплатить год можно и заранее — в строке сайта, срок продлится на 12 месяцев.',
  ],
  [
  ...
  [
    'Как отключить сайт?',
    'В «Подписке», в строке сайта, выключите «Автопродление». Сайт проработает до конца оплаченного срока, дальше продлевать его не будем; остальные сайты это не затронет. Там же меняется тариф каждого сайта.',
  ],
  [
