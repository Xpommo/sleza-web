...
const FAQ = [
  ...
  ['Могу я добавить второй сайт?', 'Да — на «Мои сайты» нажмите «Добавить сайт». Документы, виджет и тариф у каждого сайта свои, счёт — один на все сайты аккаунта.'],
  [
    'Как отключить сайт?',
    'В «Подписке», в строке нужного сайта, — «Отключить». Отключается только он: виджет и документы работают до конца оплаченного периода, в следующий счёт сайт не войдёт. Там же меняется тариф каждого сайта.',
  ],
  [
