...
// Ответы — про этот кабинет, а не про макет: где что лежит сейчас. Четыре
...
// «Показать код установки»), здесь они приведены к действительности.
const FAQ = [
  ...
  [
    ...
    'На «Обзоре» сайта рядом с названием компании нажмите «Изменить» — поправите поля сами. Документ «Реквизиты владельца» и подвал сайта обновятся вместе с ними. Реквизиты для счёта — отдельные, они в «Подписке».',
  ],
  ...
  [
    ...
    'Откройте раздел «Виджет» — там видно, стоит ли код на сайте. Если баннера и подвала нет, проверьте, что строка кода из того же раздела стоит внутри <head> и страницы опубликованы заново. Иногда страница сайта не успевает обновиться: изменения появляются с задержкой.',
  ],
];
