...
// (у каждого сайта свой тариф и год подписки, отключение в «Оплате»,
// реквизиты в «Документах»), здесь они приведены к действительности.
const FAQ = [
  [
    'Как оплачивается подписка?',
    'С баланса аккаунта: пополните его в «Оплате» картой или по счёту, а оплата года каждого сайта спишется сама в его дату продления. Оплатить год можно и заранее — в строке сайта, срок продлится на 12 месяцев.',
  ],
  [
  ...
  [
    ...
    'В разделе «Документы» сайта, в блоке «Что можно изменить», нажмите «Изменить» у «Реквизитов владельца» — поправите поля сами. Документ и подвал сайта обновятся вместе с ними. Реквизиты для счёта — отдельные, они в «Оплате».',
  ],
  ...
  [
    'Как отключить сайт?',
    'В «Оплате», в строке сайта: «⋯» → «Отключить сайт». Сайт проработает до конца оплаченного срока, дальше продлевать его не будем; остальные сайты это не затронет. Если не хотите автоматических списаний, отключать сайт не нужно — выключите «Автопродление» и продлевайте вручную.',
  ],
  // Акты вынесены в свой раздел (владелец 24.09) — бухгалтер их ищет.
  ['Где чеки, счета и акты?', 'В «Бухгалтерии»: там почта, на которую они приходят, история операций по балансу и акты за оплаченные годы сайтов. Раздел появляется после первого пополнения.'],
  [
