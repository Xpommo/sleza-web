...
// Баланс аккаунта — строка над блоком аккаунта (владелец 24.09).
export const WalletIcon = (p) => (
  <Svg {...p}><path d="M19 7V5.5A1.5 1.5 0 0 0 17.5 4H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2H5" /><path d="M16.5 14h.01" /></Svg>
);

// «Бухгалтерия» — чеки, счета, акты (владелец 24.09).
