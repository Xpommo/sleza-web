...
function SampleReport() {
  return (
    <div className="bg-white border border-line-2 rounded-[10px] overflow-hidden">
      {/* meta header */}
      <div className="bg-paper border-b border-line px-6 py-3.5 flex flex-wrap gap-x-6 gap-y-2 items-center font-mono text-[11px] text-ink/60">
      ...
      {/* verdict */}
      <div className="px-6 py-8 border-b border-line grid md:grid-cols-[1fr_auto] gap-8 items-center">
        <div>
        ...
        <div className="flex flex-col gap-2 items-start md:items-end min-w-[240px]">
          <div className="label-micro">риск-скор</div>
          <div className="w-[240px] h-2 bg-warm border border-line rounded-full overflow-hidden">
            <div className="h-full rounded-full" style={{ width: '84%', background: 'linear-gradient(90deg, #b87900 0%, #d63816 100%)' }} />
          </div>
          <div className="w-[240px] flex justify-between font-mono text-[10px] text-ink/25">
      ...
      <div>
        {SAMPLE_FINDINGS.map((f, i) => (
          <div key={i} className="grid grid-cols-[40px_minmax(0,1.4fr)_minmax(0,2fr)_auto_28px] gap-4 px-6 py-4 items-start border-b border-line">
            <div className="font-mono text-[11px] text-ink/25 tracking-wider pt-1">{String(i + 1).padStart(2, '0')}</div>
            <div>
            ...
            <div className="text-right whitespace-nowrap pt-0.5">
              <div className="font-mono text-[9px] uppercase tracking-wider text-ink/25 mb-0.5">штраф до</div>
        ...
        {/* locked rows */}
        {[0, 1].map(i => (
          <div key={`l${i}`} className="grid grid-cols-[40px_minmax(0,1.4fr)_minmax(0,2fr)_auto_28px] gap-4 px-6 py-4 items-start border-b border-line last:border-b-0 opacity-50 pointer-events-none select-none" style={{ filter: 'blur(4px)' }}>
            <div className="font-mono text-[11px] text-ink/25 tracking-wider pt-1">0{5 + i}</div>
            <div>
      ...
      {/* CTA below */}
      <div className="px-6 py-6 bg-paper border-t border-line text-center relative">
