...
const LAWS = [
  { code: '152-ФЗ',   tag: 'данные',    name: 'Персональные данные',        desc: 'Политика конфиденциальности, явное согласие на обработку, cookie-баннер.',                                                                  fine: 'до 300 000 ₽',  tooltip: 'Касается любого сайта с формами, аналитикой или cookies. Нужна политика конфиденциальности, явное согласие и возможность отказаться.' },
  { code: '149-ФЗ',   tag: 'реквизиты', name: 'Информация о владельце',     desc: 'ИНН, ОГРН, юридический адрес, email и телефон на сайте · сверка с ЕГРЮЛ.',                                                                  fine: 'до 100 000 ₽',  tooltip: 'Любой сайт обязан раскрыть: ИНН, ОГРН/ОГРНИП, юр. адрес и контакты. Сверяем с ЕГРЮЛ/ЕГРИП — несовпадение считается нарушением.' },
  { code: 'ЕРИР',     tag: 'реклама',   name: 'Маркировка рекламы',          desc: 'Метка «реклама», токен ERID, корректность данных рекламодателя.',                                                                           fine: 'до 500 000 ₽',  tooltip: 'Только для сайтов с рекламными блоками. Каждый баннер или интеграция обязаны иметь пометку «реклама» и токен ERID от Роскомнадзора.' },
  { code: 'ЗоЗПП',    tag: 'оферта',    name: 'Условия продажи и возврата', desc: 'Условия продажи, возврата и обмена товаров и услуг.',                                                                                        fine: 'до 500 000 ₽',  tooltip: 'Для магазинов, SaaS и сервисов с оплатой. Нужна публичная оферта или условия использования с порядком возврата и контактами продавца.' },
  { code: 'Реестры',  tag: 'иноагенты', name: 'Иноагенты и экстремисты',    desc: 'Упоминания без обязательной маркировки по реестрам иноагентов, экстремистов и нежелательных организаций (1175+ субъектов).',              fine: 'до 5 000 000 ₽', tooltip: 'Проверяем по реестрам иноагентов, экстремистов и нежелательных организаций. Упоминание без обязательной маркировки — нарушение даже в цитатах.' },
  { code: 'ФЗ № 3',   tag: 'запрет',    name: 'Запрещённые вещества',       desc: 'Пропаганда или незаконный оборот запрещённых веществ.',                                                                                     fine: 'до 1 500 000 ₽', tooltip: 'Пропаганда, реклама или позитивное упоминание наркотических и психотропных веществ. Большинства сайтов не касается — но проверяем.' },
];

const AUDIENCE = [
  ['владельцы бизнеса',   'У вас магазин, услуги или b2b-сервис. Compliance — не ваша работа, но штрафы от РКН вполне реальные. Узнаете о проблеме за 5 минут, пока письмо ещё не пришло.'],
  ['веб-агентства',       'Сдаёте сайты клиентам. Включите проверку в чек-лист сдачи — клиент не получит штраф, вы не получите претензию.'],
  ['маркетинг-команды',   'Ведёте рекламу и аналитику. ЕРИР и cookie-согласие — на вас. Проверьте сейчас, отдайте PDF директору.'],
  ['юристы и комплаенс',  'Быстрый аудит клиентских сайтов с PDF-отчётом и цитатами статей законов.'],
];
