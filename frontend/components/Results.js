...
function FindingRow({ check, idx, diffEntry, scanUuid }) {
  ...
  return (
    <div className="px-5 sm:px-6 py-4 border-b border-line last:border-b-0 hover:bg-warm/40 transition-colors grid sm:grid-cols-[40px_minmax(0,1.4fr)_minmax(0,2fr)_auto_28px] gap-3 sm:gap-4 items-start">
